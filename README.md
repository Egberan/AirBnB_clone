...
Clone the repository. git clone https://github.com/egberan/AirBnB_clone.git
Open the /AirBnB_clone directory and execute console.py

Setup
ou need Python interpreter. IMPORTANT: The project was created in UBUNTU 14.04.3 LTS and Python 3.4.3.
